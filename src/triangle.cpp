...
//    cout<<"GL"<<'\n';
    ...
    glColor3ui(colors[1].r, colors[1].g, colors[1].b); glVertex3f(vertices[1].x, vertices[1].y, vertices[1].z);
    glColor3ui(colors[2].r, colors[2].g, colors[2].b); glVertex3f(vertices[2].x, vertices[2].y, vertices[2].z);
    glEnd();
#endif
}
