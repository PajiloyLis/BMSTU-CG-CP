...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayout->addWidget(simulation_start_button, 11, 0, 1, 3);
        ...
        gridLayout->addWidget(sim_speed_slider, 9, 1, 1, 1);
        ...
        gridLayout->addWidget(sim_speed_label, 10, 0, 1, 3);
        ...
        sizePolicy1.setHeightForWidth(loaded_model_name->sizePolicy().hasHeightForWidth());
        loaded_model_name->setSizePolicy(sizePolicy1);
