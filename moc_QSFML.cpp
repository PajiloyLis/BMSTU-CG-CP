...
static const uint qt_meta_data_QSFMLCanvas[] = {
        ...
        12, 2, 101, 2, 0x06, 14 /* Public */,
        13, 2, 106, 2, 0x06, 17 /* Public */,
        14, 2, 111, 2, 0x06, 20 /* Public */,
        15, 1, 116, 2, 0x06, 23 /* Public */,
        17, 1, 119, 2, 0x06, 25 /* Public */,
        18, 2, 122, 2, 0x06, 27 /* Public */,
...
void QSFMLCanvas::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a) {
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
            case 0:
                _t->LeftMouseButton((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),
                                    (*reinterpret_cast< std::add_pointer_t<int>>(_a[2])));
                break;
            case 1:
                _t->ShiftLeftMouseButton((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),
                                         (*reinterpret_cast< std::add_pointer_t<int>>(_a[2])));
                break;
            case 2:
                _t->RightMouseButton();
                break;
            case 3:
                _t->LeftMouseButtonDouble((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),
                                          (*reinterpret_cast< std::add_pointer_t<int>>(_a[2])));
                break;
            case 4:
                _t->WKeyPressed((*reinterpret_cast< std::add_pointer_t<Camera_Movement>>(_a[1])),
                                (*reinterpret_cast< std::add_pointer_t<float>>(_a[2])));
                break;
            case 5:
                _t->AKeyPressed((*reinterpret_cast< std::add_pointer_t<Camera_Movement>>(_a[1])),
                                (*reinterpret_cast< std::add_pointer_t<float>>(_a[2])));
                break;
            case 6:
                _t->SKeyPressed((*reinterpret_cast< std::add_pointer_t<Camera_Movement>>(_a[1])),
                                (*reinterpret_cast< std::add_pointer_t<float>>(_a[2])));
                break;
            case 7:
                _t->DKeyPressed((*reinterpret_cast< std::add_pointer_t<Camera_Movement>>(_a[1])),
                                (*reinterpret_cast< std::add_pointer_t<float>>(_a[2])));
                break;
            case 8:
                _t->WheelScrolledUp((*reinterpret_cast< std::add_pointer_t<float>>(_a[1])));
                break;
            case 9:
                _t->WheelScrolledDown((*reinterpret_cast< std::add_pointer_t<float>>(_a[1])));
                break;
            case 10:
                _t->MouseMove((*reinterpret_cast< std::add_pointer_t<float>>(_a[1])),
                              (*reinterpret_cast< std::add_pointer_t<float>>(_a[2])));
                break;
            case 11:
                _t->SmokeTimerElapsed();
                break;
            default:;
        }
